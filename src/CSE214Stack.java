public interface CSE214Stack<T>{
    ...
    /**
     * Returns the top element of this stack, without removing it from this stack.   * Throws {@link java.util.NoSuchElementException} if this stack is empty.   *
     * @return the top element of this stack, if it exists
     */
    T peek();

    /**
     * Pops and returns the top element of this stack. If the stack is empty, throws   * {@link java.util.NoSuchElementException}.
     *
     * @return the top element of this stack, if it exists
     */
    T pop();
